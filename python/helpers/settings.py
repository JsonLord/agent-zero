...
def get_default_settings() -> Settings:
    return Settings(
        ...
        browser_model_provider="Other OpenAI compatible",
        browser_model_name="alias-large,
        browser_model_api_base="https://api.helmholtz-blablador.fz-juelich.de/v1",
