...
- Hugging Face deployment sync lives in `workflows/deploy-huggingface-space.yml` and force-mirrors a clean snapshot of `main` to the `Leon4gr45/agent` Docker Space using the `HF_TOKEN` repository secret.
